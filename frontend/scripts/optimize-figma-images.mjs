/**
 * Convert Figma downloads into optimized webp assets + favicons.
 * Run: node scripts/optimize-figma-images.mjs
 */
...
async function main() {
  ...
  // China / Turkey heroes (pages 1-2 of delivery)
  ...
  // ICO via png fallback also as public/favicon.ico won't be true ico; use 32 png named for browsers + metadata
